...
public class Base extends JFrame {//created by Robert Petrelli
	...
	private void createUserInterface()
    {
		...
		maleJRadio.setBounds(120,180,70,50);
		...
		femaleJRadio.setBounds(285,180,90,50);
		...
		liquorPicJLabel.setBounds( 410, 300, 20, 42 ) ;
		...
		FoodJCheck = new JCheckBox("Have you eaten recently?");
		FoodJCheck.setBounds(50,420,200,20);
		...
		WaterJCheck = new JCheckBox("Did you drink water recently?");
		WaterJCheck.setBounds(50,440,230,20);
		...
		WellRestedJCheck = new JCheckBox("Have you slept well?");
		WellRestedJCheck.setBounds(50,460,200,20);
		...
		DrugJCheck = new JCheckBox("Are you currently on any medication?");
		DrugJCheck.setBounds(50,480,275,20);
											...
											default:
												...
												if (drug == true) { //yes food yes water no sleep yes drug
													...
													case 4:
														...
														break;
													case 5://created by Robert Petrelli
